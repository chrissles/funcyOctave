...
function [param] = setOptions(varargin)
        ...
        param = struct('bwmu',0,'bwmu_gcv', 1, 'bwxcov',[0 0],...
                   ...
                   'rho','cv', 'family','binomial','param',[],'verbose','on','xmu',[],'xcov',[], 'method_mu', [], 'out_percent', []);
        if nargin > 0
            op_names = {'bwmu','bwmu_gcv','bwxcov', ...
	                ...
	                'error','ngrid','method',...
                        ...
                        ,'screePlot','designPlot', 'corrPlot', 'rho','family','param','verbose','xmu','xcov','method_mu', 'out_percent'};
